...
class AccountantProfit(models.Model):
    _name = 'accountant.profit'
    _description = 'this is Profit statement'
...
class AccountantProfitSet(models.Model):
    _name = 'accountant.profit.set'
    _description = 'this is Profit set'
    ...
    company_id = fields.Many2one('res.company', string='公司',
                                 store=True, index=True, readonly=False, required=True)
    amount_a = fields.Char(string='主营业务收入', store=True, required=True)
    amount_b = fields.Char(string='主营业务成本',store=True, required=True)
    amount_d = fields.Char(string='其他业务利润',store=True, required=True)
    amount_e = fields.Char(string='销售费用',store=True, required=True)
    amount_f = fields.Char(string='管理费用',store=True, required=True)
    amount_g = fields.Char(string='财务费用',store=True, required=True)
    amount_i = fields.Char(string='营业外收入',store=True, required=True)
    amount_j = fields.Char(string='营业外支出',store=True, required=True)
    amount_l = fields.Char(string='所得税',store=True, required=True)
    amount_n = fields.Char(string='资产减值损失',store=True, required=True)
    amount_o = fields.Char(string='投资收益',store=True, required=True)
    amount_p = fields.Char(string='公允价值变动收益',store=True, required=True)
